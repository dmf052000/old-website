...
$.src="https://v2.zopim.com/?3MQCDATWTNPLfybbf9eSIbAqqasarTda";z.t=+new Date;$.
...
<header id="header" class="header navbar-fixed-top">
  <div class="container">
    <h1 class="logo"> <a href="index.php"><span class="text"><img class="header-logo" src="assets/img/logo.png"> <img class="header-top" src="assets/img/logo.png"></span></a> </h1>
    <!--//logo-->
...
if(isset($_POST['contact-submit'])){
    ...
    if(mail($to,$subject,$message,$headers)){
		...
		echo "<p>Unable to Send mail. please try again later.</p>";
	}
}
?>
</div>
